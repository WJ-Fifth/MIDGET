...
class CrossCondGPTBase(nn.Module):
    ...
    def forward(self, idx_up, idx_down, cond):
        ...
        token_embeddings_cond = self.cond_emb(cond.to(torch.float32))

        token_embeddings = torch.cat([token_embeddings_cond, token_embeddings_up, token_embeddings_down], dim=1)
