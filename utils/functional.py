...
def load_data_aist(data_dir, interval=240, move=8, rotmat=False, external_wav=None, external_wav_rate=1,
                   wav_padding=0):
    tot = 0
    music_data, dance_data = [], []
    fnames = sorted(os.listdir(data_dir))
...
def load_test_data_aist(data_dir, rotmat, move, external_wav=None, external_wav_rate=1,
                        wav_padding=0):
    tot = 0
    input_names = []
