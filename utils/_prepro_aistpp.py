...
# parser.add_argument('--sampling_rate', type=int, default=15350 * 2)
parser.add_argument('--sampling_rate', type=int, default=15360 * 2)  # 512 * 60
...
def make_music_dance_set(video_dir, annotation_dir):
    ...
    for audio_fname in all_names[0:5]:
        ...
        loader = None
        try:
            # load audio features with essentia #
            ...
            # load audio features with librosa #

            audio, _ = librosa.load(video_file, sr=sr)
        except RuntimeError:
            continue
        ...
        dances.append(keypoints3d.reshape(keypoints3d.shape[0], -1).tolist())
